...
overlayTrigger.addEventListener('click', () => {
    ...
    // Ruta hacia la subcarpeta donde Angel tenga su propia compilación WebGL de La Vaca Lola
    unityIframe.src = "./vaca_build/index.html"; 
});

// Arrastre Ventana Flotante (Drag)
...
// Redimensionamiento Bidireccional (Resize)
